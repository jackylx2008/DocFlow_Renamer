"""Legacy implementation kept temporarily for parser and AI compatibility.

New workflows must live in focused modules. This module will be reduced as
services are extracted and is not an application entry point.
"""
